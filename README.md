...
- **Cụm Phân Khu 1**: Đồn an ninh số 1 (`db_don_1` tại port `5001`) & Đồn dự phòng số 1 (`db_don_1_du_phong` tại port `5003`).
- **Cụm Phân Khu 2**: Đồn an ninh số 2 (`db_don_2` tại port `5002`) & Đồn dự phòng số 2 (`db_don_2_du_phong` tại port `5004`).
...
```bash
go run main.go 5001 db_don_1
```
**Terminal 2 (Đồn an ninh 1 - Node Dự phòng):**

```bash
go run main.go 5003 db_don_1_du_phong
```
**Terminal 3 (Đồn an ninh 2 - Node Chính):**
```Bash
go run main.go 5002 db_don_2
```
**Terminal 4 (Đồn an ninh 2 - Node Dự phòng):**
```Bash
go run main.go 5004 db_don_2_du_phong
```
